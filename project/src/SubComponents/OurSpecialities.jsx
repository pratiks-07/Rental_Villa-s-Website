...
// First i create 5 id which gives properties of specific objects
// then i can use map methd here because map method is used to render all objects in perticular array.